...
public interface StoreApi {
    ...
    ResponseEntity<Void> deleteOrder(@DecimalMin("1.0")@ApiParam(value = "ID of the order that needs to be deleted",required=true) @PathVariable("orderId") Integer orderId);
    ...
    @RequestMapping(value = "/store/order/{orderId}",
        ...
        method = RequestMethod.GET)
    ResponseEntity<Order> getOrderById(@DecimalMin("1.0") @DecimalMax("10.0") @ApiParam(value = "ID of pet that needs to be fetched",required=true) @PathVariable("orderId") Integer orderId);
