...
public class StoreApiController implements StoreApi {
    ...
    public ResponseEntity<Void> deleteOrder(@DecimalMin("1.0")@ApiParam(value = "ID of the order that needs to be deleted",required=true) @PathVariable("orderId") Integer orderId) {
    ...
    public ResponseEntity<Order> getOrderById(@DecimalMin("1.0") @DecimalMax("10.0") @ApiParam(value = "ID of pet that needs to be fetched",required=true) @PathVariable("orderId") Integer orderId) {
        String accept = request.getHeader("Accept");
